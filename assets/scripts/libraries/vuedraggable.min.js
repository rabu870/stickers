            ...
            h = {
                ...
                render: function (e) {
                    ...
                    var i = 0,
                        ...
                        a = s.header,
                        u = s.footer;
                    a && (i = a.length, r = r ? [].concat(_toConsumableArray(a), _toConsumableArray(r)) : [].concat(_toConsumableArray(a))), u && (r = r ? [].concat(_toConsumableArray(r), _toConsumableArray(u)) : [].concat(_toConsumableArray(u))), this.headerOffset = i;
                    var l = null,
                        d = function (e, n) {
                            l = t(l, e, n)
                        };
                ...
                mounted: function () {
                    ...
                    !("draggable" in o) && (o.draggable = ">*"), this._sortable = new e(this.rootContainer, o), this.computeIndexes()
                },
                ...
                watch: {
                    options: {
                        handler: function (t) {
                            for (var e in t) d.indexOf(e) == -1 && this._sortable.option(e, t[e])
                        },
                        deep: !0
                    },
                    realList: function () {
                ...
                methods: {
                    ...
                    onDragRemove: function (t) {
                        if (this.updateEvenemt(t), o(this.rootContainer, t.item, t.oldIndex), this.isCloning) return void n(t.clone);
                    ...
                    computeFutureIndex: function (t, e) {
                        ...
                        var n = [].concat(_toConsumableArray(e.to.children)).filter(function (t) {
